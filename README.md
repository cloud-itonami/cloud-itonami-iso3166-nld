# cloud-itonami-iso3166-nld

Open ISO 3166 Blueprint for **NLD**: the Netherlands.
...
tax registration, and local-content rules in the Netherlands, so the operator
...
- **Not the government of the Netherlands.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Dutch-licensed counsel
...
(ISO 3166 `NLD`). Required capabilities:
